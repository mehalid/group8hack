#Load Datasheet - for our case we run a function to create the dataset
#Run make_datsheet.R to load the dataset

#Upload functions: SPC.R, Bargraph.R, pdf_function.R

#Control Plot Function: Call StatisticalProcessTest Function w/ efficiency values from dataset-----
...
#Bar Graph: will give you a bar plot with the occurrences of each failure mode----
#Open Bargraph.R for more info
bar = Bargraph(farm_bad)

#Open and Run statistics.R
